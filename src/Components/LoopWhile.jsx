...
const LoopWhile = ({ data, renderItem, filter, sort, limit, reverse, mapTransform, groupBy, uniqueBy, slice, shuffle }) => {
  try {
    ...
    console.error(`[LoopWhile] Error:`, error);
    return (
      <p style={{ color: "red", fontWeight: "bold" }}>
        ⚠️ Error: Invalid props in <strong>LoopWhile</strong>. Details:{" "}
        {error.message}
      </p>
    );
  }
